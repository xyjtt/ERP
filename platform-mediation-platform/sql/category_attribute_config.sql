...
-- 插入默认店铺配置
INSERT INTO [dbo].[shop_publish_config] 
([shop_id], [platform], [ship_from_template], [freight_template], [ship_time_template], [buyer_protection_ship_time], [default_quantity], [default_brand], [default_material], [default_style], [default_space])
VALUES
(10001, '1688', '江苏省常州市武进区横洛路219号', '日常模板', '24小时发货', '15天发货', 999, '速班达', '人造板', '现代简约', '卧室');