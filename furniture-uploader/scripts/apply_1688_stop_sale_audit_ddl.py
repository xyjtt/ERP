...
from stop_sale_audit import StopSaleAuditRepository, connect_app_database, resolve_stop_sale_app_config


DDL_PATH = PROJECT_ROOT / "sql" / "360_ali1688_stop_sale_audit.sql"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate or apply the 1688 stop-sale audit DDL.")
...
def main() -> int:
    ...
    if args.apply:
        result["contract"] = StopSaleAuditRepository(config).check_contract()
    print(result)
    return 0
