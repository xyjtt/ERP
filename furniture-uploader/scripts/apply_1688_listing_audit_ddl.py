...
DDL_PATH = PROJECT_ROOT / "sql" / "361_ali1688_listing_workflow.sql"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate or apply the 1688 listing audit DDL.")
    parser.add_argument(
        "--shared-runtime-root",
...
def main() -> int:
    ...
    if args.apply:
        result["contract"] = ListingAuditRepository(config).check_contract()
    print(result)
    return 0
