...
- Fresh runtime inspection immediately before installation reported `crawler_active_count=0`, no active account/browser/request leases and no account lock. Stop-Sale remained Ready; this work did not call, deploy or restart the independent Crawler Worker. Later Scheduler events show an external stop at 13:27 followed by starts at 13:29/13:31; its final state is Running and must remain a separate evidence line.
